    ...
    <div className="min-h-screen bg-coffee scroll-smooth flex flex-col">
      ...
      <main className="flex-1 pt-24">
        ...
        <div className="relative h-[40vh] md:h-[50vh] min-h-[300px] w-full">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-coffee via-coffee/60 to-transparent" />
          ...
          <div className="absolute inset-0 flex flex-col justify-end pb-12">
            <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center gap-3 text-[10px] md:text-xs uppercase tracking-[0.28em] text-copper mb-4" style={{ fontFamily: "var(--font-display)" }}>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl text-cream font-bold uppercase leading-tight" style={{ fontFamily: "var(--font-display)" }}>
                {article.title}
              </h1>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
          <article className="prose prose-invert prose-lg prose-copper mx-auto max-w-none">
            {article.excerpt && (
              <p className="text-xl md:text-2xl text-cream/90 font-serif italic mb-10 leading-relaxed border-l-4 border-copper pl-6">
                {article.excerpt}
              </p>
            )}
